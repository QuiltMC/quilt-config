/*
 * Copyright zml and Configurate contributors
...
package org.quiltmc.config.api.naming;
...
public enum NamingSchemes implements NamingScheme {
    ...
    /**
     * Reformats names to {@code lower-case-dashed} format, also known as {@code kebab-case}.
     */
    LOWER_CASE_DASHED {
        @Override
        public String coerce(final String input) {
