...
public final class TestReflectiveConfig extends ReflectiveConfig {
	...
	@Matches("[a-zA-Z]+")
	public final TrackedValue<String> whatever = value("Riesling");
	public final Nested nested1 = new Nested(10, 11, 12, 13);
	public final Nested nested3 = new Nested(20, 21, 22, 23);

	public final TrackedValue<ValueList<String>> enabled = list("");
	...
	public final TrackedValue<ValueMap<ValueList<String>>> key_binds = map(ValueList.create("")).build();
